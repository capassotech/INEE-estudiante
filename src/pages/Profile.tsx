        ...
        <div className="font-sans container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-6 sm:space-y-8 min-h-screen text-[#4B4B4C]">
            ...
            <section className=" rounded-xl shadow-lg p-6 space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-semibold text-[#8B3740] dark:text-white">{user.nombre} {user.apellido}</h2>
                        <p className="text-sm text-[#4B4B4C] dark:text-zinc-300">{user.email}</p>
                        <p className="text-sm text-[#4B4B4C] dark:text-zinc-300">DNI: {user.dni}</p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-[#4B4B4C] dark:text-zinc-200">Nombre completo</label>
                        <input
                            type="text"
                            disabled
                    ...
                    {/* Por ahora dejamos los inputs en disable hasta tener la funcionalidad de editar el perfil */}
                    <div>
                        <label className="block text-sm font-medium text-[#4B4B4C] dark:text-zinc-200">Correo electrónico</label>
                        <input
                            type="email"
                            disabled
                ...
                <div className="flex justify-end gap-4">
                    <Button onClick={() => logout()} variant="outline" className="px-6 py-3 text-black dark:text-white rounded-lg hover:bg-[#D8A848] transition-colors font-medium">
                        <LogOut className="w-5 h-5" />
                        Cerrar sesión
                    </Button>
                    <Button variant="outline" className="px-6 py-3 bg-[#8B3740] dark:bg-zinc-700 text-white rounded-lg hover:bg-[#D8A848] transition-colors font-medium">
                        Guardar cambios
                    </Button>
                </div>
            </section>
