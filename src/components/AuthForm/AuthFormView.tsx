...
import type { PasswordRequirementsState } from "@/utils/passwordRequirements";
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className={`pl-10 form-input ${errors.firstName
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className={`pl-10 form-input ${errors.lastName
                                ? "border-destructive ring-destructive"
                                : ""
                                }`}
            ...
            <div className="space-y-2">
                ...
                <div className="relative">
                    ...
                    <Input
                        ...
                        className={`pl-10 form-input ${errors.dni ? "border-destructive ring-destructive" : ""
                            }`}
